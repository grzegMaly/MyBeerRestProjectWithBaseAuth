...
import myproject.beerrestwithbaseauth.beerrestwithbaseauth.mappers.BeerMapper;
...
class BeerControllerIT {
    ...
    void tesListBeersByStyleAndNameShowInventoryTruePage2() throws Exception {
        mockMvc.perform(get(BeerController.BEER_PATH)
                        ...
                        .with(user(BeerControllerTest.USERNAME).password(BeerControllerTest.PASSWORD)))
